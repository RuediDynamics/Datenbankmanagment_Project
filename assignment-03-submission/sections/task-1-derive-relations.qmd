...
> **Hinweis:** Fett-/Kursivauszeichnung im obigen Codeblock ist nicht renderbar;
> die Schlüsselzuordnung ist verbindlich in @tbl-t1-mapping (Spalten *Candidate
> Key* und *Foreign Keys*) sowie im Diagramm (@fig-logical-initial) dokumentiert.
...
### Deliverables (Task 1) {#sec-t1-deliverables}

- **Initiales logisches Datenmodell** als UML-Diagramm: @fig-logical-initial
- **PlantUML-Quelle:** `assets/diagrams/logical-model-initial.puml`
- **Gerenderte Diagramme:** `assets/diagrams/logical-model-initial.svg` (+ `.png`)
- **Mapping-Dokumentation:** @tbl-t1-mapping inkl. Begründungen (@sec-t1-rationale)
