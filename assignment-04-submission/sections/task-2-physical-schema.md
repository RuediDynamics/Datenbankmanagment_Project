...
![Initiales physisches Datenmodell (PostgreSQL 16). Quelle: `assets/diagrams/physical-model-initial.puml`](../assets/diagrams/physical-model-initial.svg){#fig-physical-initial}
