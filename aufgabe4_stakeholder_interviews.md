...
Im Folgenden werden drei strukturierte Interviews mit drei der vier Stakeholder-Personas aus Aufgabe 3 dargestellt. Ausgewählt wurden die Rollen mit den deutlichsten Unterschieden in den Datenbedürfnissen: ein strategischer Blick (Filialleiter), eine operative Tagesperspektive (Immobilienmaklerin) und ein eingeschränkter Endkundenzugang (Mieter).
